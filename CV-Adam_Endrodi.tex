...
\item	\hypertarget{TAS}{\textbf{2012/12--present}}: Nokia Software, in the
	...
	\textit{senior specialist and technical lead}, working on the
	\href{https://www.nokia.com/networks/products/telecom-application-server/}%
	{Telecom Application Server} (Nokia TAS), a \\ mi\-cro\-ser\-vices-based
	VoLTE and 5G solution component
\item	\textbf{2012/07--2012/12}:
	% \href{https://balasys.github.io/zorp/about/}{\texttt{Zorp}} firewall
...
% reviewer of specifications, feature implementations and patches
\begin{compressedItemize}
...
% The service had a simple \Yell{PHP} web interface and a \Yell{Perl} GUI.
% As by-product some \Yell{debugging tools} in \Yell{C} yielded as well.
% I also redesigned the database schema and migrated it from Oracle to
% \Yell{PostgreSQL}.
...
%\midline\par
%\Label{Project name}: \hypertarget{mcompositor}{\href{https://github.com/nemomobile-graveyard/mcompositor}{\texttt{mcompositor}}}\hfill
...
%\midline\par
%\Label{Project name}:
%\href{https://github.com/Cordia/hildon-desktop}{\texttt{hildon-desktop}}\hfill
...
%\href{https://www.libsdl.org}{SDL}).\par\medskip
...
%They are \href{https://github.com/enadam?tab=repositories}{public} now,
%and even today I make use some of them.
%
%\midline\par
%\Label{Project name}: \href{https://wiki.maemo.org/Documentation/Maemo_5_Developer_Guide/Using_Multimedia_Components/Media_Application_Framework_(MAFW)}{Media Application Framework (MAFW)}\hfill
...
% no compromise if possible, but ready for it if necessary
%
% professional paranoia
% willing to study and research
% accepts others' style and respects their decisions
%
% passionate
% hungry for knowledge and experience
% motivated by fun
